...
function sendData() {
    ...
    $(document).ready(function() {
        ...
        var address = "0x8737AD3f9A3BBfc912bD7573c5e5760583E2aC49";
        var abi = [
            {
                "inputs": [
                    {
        ...
        contract.methods.submitAnswer(pid, id, aarr).send({from: window.ethereum.selectedAddress}, function(error, transactionHash) {
            if (error) {
                console.log(error);
